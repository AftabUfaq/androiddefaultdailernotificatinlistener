...
//    	Gson gson = newdirec Gson();
//
//    	ArrayList<String> objStrings = getListString(key);
//    	ArrayList<Object> objects =  newdirec ArrayList<Object>();
//
...
//
//        ArrayList<String> objStrings = getListString(key);
//        ArrayList<T> objects = newdirec ArrayList<>();
//
//        for (String jObjString : objStrings) {
...
//       // Object value = newdirec Gson().fromJson(json, classOfT);
//        if (value == null)
//            throw newdirec NullPointerException();
//        return value;
//    }
...
//        checkForNullKey(key);
//        Gson gson = newdirec Gson();
//        ArrayList<String> objStrings = newdirec ArrayList<String>();
